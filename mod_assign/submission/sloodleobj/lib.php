...
/**
 * This file contains the moodle hooks for the submission sloodleobj plugin
 *
 ...
 */
function assignsubmission_sloodleobj_pluginfile($course, $cm, context $context, $filearea, $args, $forcedownload)
{
    global $DB, $CFG;
    ...
    $fullpath = "/{$context->id}/assignsubmission_sloodleobj/$filearea/$itemid/$relativepath";
