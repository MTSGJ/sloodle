...
$string['moduletype:map'] = 'Map';
$string['moduletype:tracker'] = 'Tracker';

$string['moduletype:controller_help'] = 'The controller links a Moodle course to a set of activities in a virtual world.';
$string['moduletype:presenter_help'] = 'The presenter allows you to create slides in Moodle, and display them in a virtual world.'.
$string['moduletype:distributor_help'] = 'The distributor allows you to put virtual inventory in an object in a virtual world and distribute it to your students.';
$string['moduletype:map_help'] = '';
$string['moduletype:tracker_help'] = '';
...
$string['objectuuid'] = 'オブジェクトUUID';
$string['objecttype'] = 'オブジェクトタイプ';
...
$string['tracker:tasks'] = '課題';
$string['tracker:objdesc'] = '説明';
$string['tracker:levelcompl'] = '状態';
...
$string['tracker:completerate'] = '達成度';
$string['tracker:completed'] = '完了';
$string['tracker:notcompleted'] = '未了';
...
$string['awards:award'] = '得点'; 
$string['awards:total'] = '総得点'; 
...
$string['logs:username'] = 'ユーザ名';
$string['logs:nologs'] = 'No Logs Exist';
$string['backpack'] = 'Backpacks';
$string['backpacks:selectcontroller'] = 'コントローラの選択:';
...
//
$string['use_new_filemanager'] = '新しいファイルマネージャを使用する: ';
$string['use_new_filemanager_desc'] = '複数ファイルをドラッグ＆ドロップでアップロードするインターフェイスを使用する';
$string['opensim_money_func'] = 'OpenSim DTL/NSLマネーサーバ ';
$string['opensim_money_func_desc'] = 'OpenSim DTL/NSLマネーサーバ を使用するかどうかを指定する．';
$string['helper_script_dir'] = 'OpenSim Helper Scrupts ディレクトリ ';
$string['helper_script_dir_desc'] = 'OpenSim DTL/NSLマネーサーバ と Helper Scripts を使用する場合は，Helper Scripts がインストールされたディレクトリを指定する.';
...
$string['date_format'] = 'Y m/j, g:i:s a';
...
$string['backpack:explaine_money_display'] = '( ) 内は，お金としてOpenSimに転送された得点を示しています';
$string['backpack:magnification'] = '倍率';
