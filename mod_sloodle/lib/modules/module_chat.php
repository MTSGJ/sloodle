...
// FUNCTIONS //
    ...
    * <strong>Note:</strong> if the $author parameter is omitted or invalid, then the function will attempt to use the {@link SloodleUser} member
    ...
    */
    function add_message($message, $user = null, $timestamp = null)
    {
        ...
        if (!is_null($this->_session->active_object)) {
             $this->_session->active_object->process_interaction('default', 1, $userid, null); 
