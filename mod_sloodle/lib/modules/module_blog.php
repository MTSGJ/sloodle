...
// FUNCTIONS //
    ...
    */
    function user_can_write()
    {
        ...
        return has_capability('moodle/blog:create', context_system::instance(SITEID));
    }
    ...
    */
    function add_entry($subject, $body, $visibility = '')
    {
        ...
        sloodle_add_to_log(SITEID, 'blog_log', 'lib/modules/module_blog.php', array('userid'=>$blogEntry->userid, 'postid'=>$blogEntry->id), "Entry posted from SL/OS via Sloodle: \"{$blogEntry->subject}\"");
