...
*/
    ...
    function get_enrolled_users(){
        global $CFG;          
         ...
         $contextid = context_course::instance($this->course_object->id, IGNORE_MISSING);
         $cid=$contextid->id;
    ...
    */
    function can_user_authorise_objects()
    {
        ...
        return has_capability('mod/sloodle:objectauth', context_courese::instance($this->get_course_id(), IGNORE_MISSING));
    }
