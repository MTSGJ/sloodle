...
class SloodleResponse
{
  // DATA //
    ...
    * <strong>Optional but recommended. Ignored if null.</strong>
    * @var string
    * @access private
    */
    ...
    * <strong>Optional. Ignored if null.</strong>
    * @var mixed
    * @access private
    */
    ...
    * <strong>Optional, unless $page_number is specified. Ignored if null.</strong> <i>Not yet supported.</i>
    * @var integer
    * @access private
    */
    var $page_total = null;
    ...
    * <strong>Optional, unless $page_total is specified. Ignored if null.</strong> <i>Not yet supported.</i>
    * @var integer
    * @access private
    */
  ...
  // ACCESSORS //
    ...
    */
    ...
    /**
    * Accessor function to set member value {@link $side_effects}. <strong>Note:</strong> it is recommended that you use {@link add_side_effect()} or {@link add_side_effects()} instead.
    ...
    */
    ...
    /**
    * Accessor function to set member value {@link $data}. <strong>Note: it is recommended that you use the {@link add_data_line()} and {@link clear_data()} functions instead of this.</strong>
...
class SloodleRequest
{
  // DATA //
    ...
    * <strong>Always check the status of the variable before using it!</strong>
