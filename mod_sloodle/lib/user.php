...
// ACCESSORS //
    ...
    */
    ...
    {
        //if ($this->avatar_data==null) return null;
...
// USER LINK FUNCTIONS //
    ...
    * <strong>NOTE:</strong> does not remove any other avatar links to the VLE user.
...
///// COURSE FUNCTIONS /////
    ...
    */
    function get_staff_courses($category = null)
    {
        ...
        foreach ($courses as $course) {
            ...
            if (has_capability('mod/sloodle:staff', context_course::instance($course->id, IGNORE_MISSING), $this->user_data->id)) {
                $sc = new SloodleCourse();
                $sc->load($course);
                $usercourses[] = $sc;
            }
    ...
    */
    function is_enrolled($courseid)
    {
        ...
        if (!$context = context_course::instance($courseid, IGNORE_MISSING)) return false;
    ...
    */
    function enrol($sloodle_course = null)
    {
        ...
        if (!$context = context_course::instance($course->id, IGNORE_MISSING)) return false;
        ...
        if (SLOODLE_IS_ENVIRONMENT_MOODLE_2) {
            ...
            foreach($enrolinstances as $instance) {
                ...
                if ($plugin->show_enrolme_link($instance)) {
                    ...
                    sloodle_add_to_log($course->id, 'user_log', 'lib/user.php', array(), 'user: auto-enrolment');
                    return true;
                }
            }
        }
...
///// USER-CENTRIC OBJECTS /////
    ...
    */
    static function SiteAdminUserIDsToAvatarNames()
    {
       global $CFG;
