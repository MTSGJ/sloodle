...
{
    integer i;
    for (i=0; i<llGetListLength(optext_current); i++) {
...
finish_quiz() 
{
    ...
    llMessageLinked(LINK_ALL_OTHERS, SLOODLE_CHANNEL_QUIZ_MULTIPLE_RESET, "do:reset", NULL_KEY);
...
// SLOODLE LSL Script Git Location: mod/quiz_pile_on-1.0/objects/default/assets/sloodle_mod_quiz_pile_on-1.0.lsl
