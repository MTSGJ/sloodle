...
default
{
    ...
    {    
        ...
        else if (num==SLOODLE_CHANNEL_QUIZ_MULTIPLE_RESET) {
            init_script();
        }
    }
...
// SLOODLE LSL Script Git Location: mod/quiz_pile_on-1.0/objects/default/assets/sloodle_quiz_pile_on_choice.lsl
