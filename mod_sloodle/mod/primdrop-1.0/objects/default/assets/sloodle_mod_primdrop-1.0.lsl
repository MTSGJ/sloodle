...
string SLOODLE_ASSIGNMENT_VIEW = "/mod/assign/view.php";
...
state submitting
{
    ...
    http_response(key id, integer status, list meta, string body)
    {
        ...
        if (statuscode < 0) {
            ...
            else if (statuscode == -10206)  sloodle_translation_request(SLOODLE_TRANSLATE_SAY, [0], "assignment:maxobjects", [current_user_name], NULL_KEY, "assignment");
            else {
...
// SLOODLE LSL Script Git Location: mod/primdrop-1.0/objects/default/assets/sloodle_mod_primdrop-1.0.lsl
