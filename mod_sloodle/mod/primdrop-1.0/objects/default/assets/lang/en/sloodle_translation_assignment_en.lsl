/*********************************************
*  sloodle_translation_assignment_en
*********************************************/
...
list locstrings = [
    ...
    "assignment:maxobjects", "Sorry {{0}}. You have already submitted the maximum number of objects.", // Parameter: avatar name    Fumi.Hax
...
// SLOODLE LSL Script Git Location: mod/primdrop-1.0/objects/default/assets/lang/en/sloodle_translation_assignment_en.lsl
