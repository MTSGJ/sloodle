...
default
{
    ...
    link_message(integer sender_num, integer num, string str, key id)
    {
        ...
        else if (num==SLOODLE_CHANNEL_QUIZ_FAILURE_NOTHING_MORE_TO_DO_WITH_AVATAR){
            llUnSit(id);
            move_to_start( startingposition );
        }
...
// SLOODLE LSL Script Git Location: mod/quiz-1.0/objects/default/assets/sloodle_quiz_ui.lsl
