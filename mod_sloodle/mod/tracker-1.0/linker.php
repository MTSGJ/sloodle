...
// Get the parameters
$trackerid = $sloodle->request->required_param('sloodlemoduleid');
$objuuid   = $sloodle->request->required_param('sloodleobjuuid');
$avuuid    = $sloodle->request->required_param('sloodleuuid');

// Attempt to add this action to the database
$authid = $tracker->record_action($trackerid, $objuuid, $avuuid);
