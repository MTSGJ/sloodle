...
state ready
{
    ...
    touch_start( integer total_number)
    {
        ...
        if (listenctrl!=0) llListenRemove(listenctrl);
...
state logging
{
    state_entry()
    {
        ...
        if (listenctrl!=0) llListenRemove(listenctrl);
        listenctrl = llListen(SLOODLE_CHANNEL_AVATAR_DIALOG, "", NULL_KEY, "");
        llListen(0, "", NULL_KEY, "");
...
// SLOODLE LSL Script Git Location: mod/chat-1.0/objects/default/assets/sloodle_mod_chat-1.0.lsl
