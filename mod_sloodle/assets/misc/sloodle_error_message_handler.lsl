...
default
{
    ...
    state_entry()
    {
        ...
        errorMessages+=[-10206,"Submission that exceeds the maximum number of objects ","ASSIGNMENT"];    // Fumi.Iseki v2.1.2 beta
    ...
    link_message(integer sender_num, integer channel, string str, key id)
    {
        if (channel==SLOODLE_CHANNEL_ERROR_TRANSLATION_REQUEST){
            ...
            if (trans!=""){
               ...
               llSay(0,"Error Message Translation not found - please view http://slisweb.sjsu.edu/sl/index.php/Sloodle_status_codes for more information: Error Code: "+(string)statusCode);
            }
        }
    }
...
// SLOODLE LSL Script Git Location: assets/misc/sloodle_error_message_handler.lsl
